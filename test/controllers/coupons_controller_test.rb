...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { code: @coupon.code, description: @coupon.description, discount_percent: @coupon.discount_percent, expires_at: @coupon.expires_at }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { code: @coupon.code, description: @coupon.description, discount_percent: @coupon.discount_percent, expires_at: @coupon.expires_at }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
